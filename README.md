...
> **`son4.0a9` is an alpha.** The muscle models are verified against OpenSim's own
...
pip install https://github.com/son-engr-kr/mujoco-son/releases/download/v3.3.3+son4.0a9/mujoco-3.3.3+son4.0a9-cp311-cp311-linux_x86_64.whl

# macOS Apple Silicon (M1/M2/M3/M4, macOS 11+)
pip install https://github.com/son-engr-kr/mujoco-son/releases/download/v3.3.3+son4.0a9/mujoco-3.3.3+son4.0a9-cp311-cp311-macosx_11_0_arm64.whl

# Windows x86_64
pip install https://github.com/son-engr-kr/mujoco-son/releases/download/v3.3.3+son4.0a9/mujoco-3.3.3+son4.0a9-cp311-cp311-win_amd64.whl
```
